...
export function IngredientsSection({
  ...
  const Ingredient = (ingredient: RecipeIngredient) => {
    ...
    return (
      ...
      >
        {/* Ingredient image */}
        {/* {visible && (
          <div className="relative w-6 h-6 rounded-lg shrink-0">
            <Image
        ...
        {visible && (
          <div className="relative w-8 h-8 overflow-visible shrink-0">
            <Image
              ...
              width={48}
              height={48}
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-110 max-w-15 max-h-15
      object-contain rotate-6"
              onError={() => setVisible(false)}
            />
          </div>
        )}
              ...
              <div className="flex gap-1 shrink-0">
                {allergenBadges.map((badge) => (
                  <button
                    ...
                    title={
                      badge.tracesOf ? "Puede contener trazas" : "Contiene"
                    }
                  >
                    {badge.index}
                  </button>
